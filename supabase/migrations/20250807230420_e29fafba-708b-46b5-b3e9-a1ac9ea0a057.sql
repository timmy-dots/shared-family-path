...
create policy "Owners and members can view family"
  on public.families for select
  using (public.is_family_owner(auth.uid(), id) or public.is_family_member(auth.uid(), id));

create policy "Users can create family as owner"
...
create policy "Only owner can delete family"
...
create policy "Owners can add members to their family"
  on public.family_members for insert
  with check (
    public.is_family_owner(auth.uid(), family_id)
  );

create policy "Owners can update memberships in their family"
